...
public final class LauncherActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b){
        ...
        TextView title=new TextView(this); title.setText("AIRCRAFT SIMULATOR 3D • AVM-12.0"); title.setTextColor(Color.rgb(160,255,190)); title.setTextSize(30); title.setGravity(Gravity.CENTER); root.addView(title);
        TextView sub=new TextView(this); sub.setText("V20 Flight Envelope • Filament 3D • Dual Phone • Bluetooth IMU"); sub.setTextColor(Color.LTGRAY); sub.setTextSize(15); sub.setGravity(Gravity.CENTER); sub.setPadding(8,12,8,24); root.addView(sub);
        ...
        TextView hint=new TextView(this); hint.setText("AVM-12.0: IAS/Mach, stall ve sürükleme modeli, rüzgâr/türbülans, uçuş zarfı uyarıları ve kararsız yaklaşmada otomatik go-around. İki telefon modu ve tek telefon demo korunmuştur."); hint.setTextColor(Color.GRAY); hint.setTextSize(13); hint.setGravity(Gravity.CENTER); hint.setPadding(10,22,10,0); root.addView(hint);
