...
public final class LauncherActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b){
        ...
        TextView sub=new TextView(this); sub.setText("Demo uçuş • Pilot kokpiti • Bluetooth IMU • 3D savaş uçağı"); sub.setTextColor(Color.LTGRAY); sub.setTextSize(15); sub.setGravity(Gravity.CENTER); sub.setPadding(8,12,8,24); root.addView(sub);

        Button demo=new Button(this); demo.setText("DEMO UÇUŞ — OTOMATİK KALK / GEZ / İN"); demo.setAllCaps(false);
        Button pilot=new Button(this); pilot.setText("PİLOT UÇUŞU — KOKPİT KONTROLÜ"); pilot.setAllCaps(false);
        Button display=new Button(this); display.setText("3D UÇAK EKRANI — MANUEL BAĞLANTI"); display.setAllCaps(false);
        ...
        TextView hint=new TextView(this); hint.setText("Demo: pistten kendi kalkar, manzara turu yapar ve tekrar piste iner. Pilot: kokpitten sen uçurursun."); hint.setTextColor(Color.GRAY); hint.setTextSize(13); hint.setGravity(Gravity.CENTER); hint.setPadding(10,22,10,0); root.addView(hint);
