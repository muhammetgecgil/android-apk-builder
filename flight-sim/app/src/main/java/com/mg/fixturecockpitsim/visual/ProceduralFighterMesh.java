...
public final class ProceduralFighterMesh {
    ...
    private void chine(float side){
        ...
        prism(new float[][]{
                {.18f*side,.18f,-5.0f},
                {1.02f*side,.28f,-3.15f},
                {1.58f*side,.22f,-1.55f},
                {1.70f*side,.18f,-.45f},
                {.90f*side,.28f,.15f}
        },t);
    }
    ...
    private void upperDeck(){
        prism(new float[][]{
                {-.58f,.68f,-1.65f},{.58f,.68f,-1.65f},{.72f,.70f,.95f},{.48f,.72f,2.55f},
                {-.48f,.72f,2.55f},{-.72f,.70f,.95f}
        },.16f);
    }
