...
/** AVM-13.8 layered exterior renderer with PBR-like materials, transparent canopy and animated wingtip vortices. */
public final class Jet3DView extends GLSurfaceView {
    ...
    private static final class R implements Renderer {
        ...
        FloatBuffer vbOpaque,vbCanopy,obOpaque,obGlass,vortexBuffer; int opaqueCount,canopyCount,ordnanceCount,glassCount,vortexCount; long last;
        ...
        @Override public void onSurfaceCreated(GL10 g,EGLConfig e){
            ...
            float[] vortex=WingtipVortexMesh.build();vortexBuffer=buffer(vortex);vortexCount=vortex.length/7;last=System.nanoTime();
        }
