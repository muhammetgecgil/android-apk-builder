...
public class PhoneNativeActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b){
        ...
        TextView desc=new TextView(this);desc.setText("v0.45 • Adaptif llama.cpp engine + ısı/performance profili");desc.setTextSize(13);desc.setTextColor(Color.DKGRAY);root.addView(desc);
