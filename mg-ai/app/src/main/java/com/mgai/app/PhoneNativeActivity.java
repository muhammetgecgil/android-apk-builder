...
public class PhoneNativeActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b){
        ...
        TextView desc=new TextView(this);desc.setText("v0.43 • Phone-Native AI + LLM/Whisper performans telemetrisi");desc.setTextSize(13);desc.setTextColor(Color.DKGRAY);root.addView(desc);
