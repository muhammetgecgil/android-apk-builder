...
public class DashboardActivity extends Activity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView sub=new TextView(this); sub.setText("v0.11 • Multimodal Perception + Robot World Model (Perception-Only)"); sub.setTextSize(14); sub.setTextColor(Color.rgb(90,97,110)); sub.setPadding(0,dp(4),0,dp(22)); root.addView(sub);
        ...
        TextView rule=new TextView(this); rule.setText("Robot modu şu anda PERCEPTION-ONLY: world model vardır, fiziksel eylem yoktur. LLM doğrudan aktüatör süremez."); rule.setTextSize(13); rule.setTextColor(Color.rgb(95,102,116)); rule.setPadding(0,dp(22),0,0); root.addView(rule);
        setContentView(root);
    }
