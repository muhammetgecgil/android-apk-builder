...
public class DashboardActivity extends Activity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title = new TextView(this); title.setText("MG-AI"); title.setTextSize(34);
        title.setTypeface(null, android.graphics.Typeface.BOLD); title.setTextColor(Color.rgb(20, 24, 32)); root.addView(title);

        TextView sub = new TextView(this);
        sub.setText("v0.10 • Core + Research + Memory + Reasoning + Tools/Agents + Learning + Camera/Microphone");
        sub.setTextSize(14); sub.setTextColor(Color.rgb(90, 97, 110)); sub.setPadding(0, dp(4), 0, dp(22)); root.addView(sub);

        TextView summary = new TextView(this);
        summary.setText("Gereksinim entegrasyon durumu\n" + CapabilityRegistry.summary());
        summary.setTextSize(16); summary.setTextColor(Color.rgb(35, 40, 50));
        summary.setPadding(dp(14), dp(14), dp(14), dp(14)); summary.setBackgroundColor(Color.WHITE);
        ...
        rule.setText("Temel kural: doğrulama olmadan özellik ACTIVE değildir. Online weight update yoktur. Robotik fiziksel eylemler LLM'den doğrudan aktüatöre gidemez.");
        rule.setTextSize(13); rule.setTextColor(Color.rgb(95, 102, 116)); rule.setPadding(0, dp(22), 0, 0); root.addView(rule);
        setContentView(root);
    }
