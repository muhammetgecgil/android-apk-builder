...
public class DashboardActivity extends Activity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView sub=new TextView(this); sub.setText("v0.12 • Robot World Model + Deterministic Safety Supervisor"); sub.setTextSize(14); sub.setTextColor(Color.rgb(90,97,110)); sub.setPadding(0,dp(4),0,dp(22)); root.addView(sub);
        ...
        TextView rule=new TextView(this); rule.setText("Safety Supervisor deterministiktir, LLM bağımlılığı yoktur ve bu APK yalnız safety durum/audit okur. Fiziksel eylem hâlâ devre dışı."); rule.setTextSize(13); rule.setTextColor(Color.rgb(95,102,116)); rule.setPadding(0,dp(22),0,0); root.addView(rule);
        setContentView(root);
    }
