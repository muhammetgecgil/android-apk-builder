...
public class DashboardActivity extends Activity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView sub=new TextView(this); sub.setText("v0.18 • Phone-Native llama.cpp • Offline GGUF Inference"); sub.setTextSize(14); sub.setTextColor(Color.rgb(90,97,110)); sub.setPadding(0,dp(4),0,dp(22)); root.addView(sub);
        TextView summary=new TextView(this); summary.setText("Ana hedef: Sunucusuz, Jetson'sız, telefonda çalışan MG-AI\n"+CapabilityRegistry.summary()); summary.setTextSize(16); summary.setTextColor(Color.rgb(35,40,50)); summary.setPadding(dp(14),dp(14),dp(14),dp(14)); summary.setBackgroundColor(Color.WHITE); root.addView(summary,new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,LinearLayout.LayoutParams.WRAP_CONTENT));
        ...
        TextView rule=new TextView(this); rule.setText("Phone-Native modunda temel sohbet GGUF + llama.cpp ile cihaz içinde çalışır. Internet yalnız isteğe bağlı araştırma/teacher kaynağıdır."); rule.setTextSize(13); rule.setTextColor(Color.rgb(95,102,116)); rule.setPadding(0,dp(22),0,0); root.addView(rule);
        setContentView(root);
    }
