...
final class MultimodalClient {
    ...
    static void analyze(String baseEndpoint, String modality, String source, String mimeType,
    ...
    private static JSONObject provenance(String source, long capturedAtMs) throws Exception {
        return new JSONObject().put("origin", "android-device").put("source", source)
                .put("captured_at_ms", capturedAtMs).put("client", "MG-AI-Android");
    }
    ...
    private static void request(String baseEndpoint, String path, String method, JSONObject body, Callback cb) {
        new Thread(() -> {
            ...
            try {
                ...
                c.setRequestMethod(method); c.setConnectTimeout(15000); c.setReadTimeout(120000);
                if (body != null) {
