...
final class ReasoningClient {
    interface Callback {
        void onSuccess(JSONObject value);
        void onError(String message);
    }
    private ReasoningClient() {}

    static void reason(String endpoint, String task, Callback callback) {
        new Thread(() -> {
            ...
            try {
                ...
                body.put("task", task);
                body.put("evidence", new JSONArray());
                body.put("deep", true);
