...
public final class LocalChatStore {
    ...
    private static JSONArray loadArray(Context c){
        String s=c.getSharedPreferences(PREFS,Context.MODE_PRIVATE).getString(KEY,"[]");try{return new JSONArray(s);}catch(Exception e){return new JSONArray();}
    }
}
