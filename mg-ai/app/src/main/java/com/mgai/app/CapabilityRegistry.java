...
public final class CapabilityRegistry {
    ...
    static {
        ...
        x.add(new Capability("CAP-MM","Multimodal Perception","MM,VIS,ENGV,AUD,VID,SEN,OCR,3D",State.INTEGRATING,"Camera, microphone, IMU/magnetometer capture, multimodal event/fusion contract and vision/audio/OCR adapter layer added; live model-host validation pending"));
        x.add(new Capability("CAP-WORLD","World Model / Science / Engineering","WMD,CAU,CF,PHY,SIM,SCI,MATH,ENG,REQ,TRC,DTW,PRED,ANO",State.PLANNED,"World-state architecture is next after multimodal capture is validated"));
        ...
        x.add(new Capability("CAP-PROD","Android / Web / Governance","PERS,UX,MOB,WEB,GOV,AUDT,ROL,INC,CMP,DOC",State.INTEGRATING,"Android dashboard/chat/research/memory/reasoning/tools/learning/multimodal screens integrated"));
        x.add(new Capability("CAP-ROBOT","Embodied AI / Robot Brain","EMB-001..020,R27,R28,R29,R30",State.INTEGRATING,"Embodied architecture defined; Android camera/IMU/magnetometer now provide prototype perception input; no actuator control enabled"));
        ...
        x.add(new Capability("CAP-RPER","Robot Perception & World Model","RGB,DEPTH,LIDAR,IMU,ENCODER,F/T,TACTILE,SLAM,POSE",State.INTEGRATING,"Prototype RGB/IMU/magnetometer ingestion exists; depth/LiDAR/SLAM/pose/world-model fusion remain"));
        x.add(new Capability("CAP-RACT","Robot Planning / Control / Manipulation","TASK,MOTION,IK,FK,TRAJ,COLLISION,GRASP,FORCE,TELEOP",State.PLANNED,"No physical actuator path enabled; safety supervisor must precede this phase"));
