...
public final class AutonomousAnalysisRunner {
    ...
    public static Result run(MeshModel model){
        ...
        boolean mappingReady=f.setup!=null && f.setup.fixedNodes>=3 && f.setup.loadedNodes>0;
        ...
        boolean primaryReady=s.convergence.converged && f.fem.linearSolve.converged && f.fem.forceEquilibriumRelativeError<1e-5 && nonZeroResponse && mappingReady;
        ...
        String txt=String.format(Locale.US,
            ...
            mapDiag,responseWatchdog,HotspotSingularityAnalyzer.summary(h),criticalWhy,u.passed,u.scenarios.size(),capacityLine,
