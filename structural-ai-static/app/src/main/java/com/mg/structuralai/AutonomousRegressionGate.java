...
public final class AutonomousRegressionGate {
    ...
    public static Result run(){
        ...
        try{
            ...
            ContactRegressionGate.Result cr=ContactRegressionGate.run();FrictionalContactRegressionGate.Result fcr=FrictionalContactRegressionGate.run();ProductionMeshGate.Result pm=ProductionMeshGate.run();BoundaryLoadRegressionGate.Result bc=BoundaryLoadRegressionGate.run();MaterialEvidenceGate.Result mg=MaterialEvidenceGate.run();ContactEvidenceRegressionGate.Result ceg=ContactEvidenceRegressionGate.run();ProfessionalResultsRegressionGate.Result pr=ProfessionalResultsRegressionGate.run();AssemblyBodySplitRegressionGate.Result abs=AssemblyBodySplitRegressionGate.run();
            boolean pass=femPass&&tet.pass&&theory.pass&&axial.pass&&cr.pass&&fcr.pass&&pm.pass&&bc.pass&&mg.pass&&ceg.pass&&pr.pass&&abs.pass;
