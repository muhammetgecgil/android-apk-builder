...
public final class P1ReleaseAcceptanceGate {
    public static final class Result {
        ...
        public final boolean packageIdentityOk, versionCodeOk, arm64Ok, occtOk, goldenOk, reportEvidenceOk, productionBuild;
        ...
        Result(boolean testReady, boolean productReady,
               ...
               boolean goldenOk, boolean reportEvidenceOk, boolean productionBuild, String summary){
            ...
            this.goldenOk=goldenOk;this.reportEvidenceOk=reportEvidenceOk;this.productionBuild=productionBuild;this.summary=summary;
        }
    }
    ...
    public static Result run(boolean goldenOk, boolean reportEvidenceOk){
        ...
        boolean productReady=testReady&&productionBuild;
        ...
        String summary=String.format(Locale.US,
            "P1 RELEASE ACCEPTANCE %s | package=%s | versionCode=%d versionName=%s | arm64=%s | OCCT=%s | golden=%s | reportEvidence=%s | buildType=%s | productionBuild=%s",
            state,BuildConfig.APPLICATION_ID,BuildConfig.VERSION_CODE,BuildConfig.VERSION_NAME,arm64Ok,occtOk,goldenOk,reportEvidenceOk,BuildConfig.BUILD_TYPE,productionBuild);
        return new Result(testReady,productReady,packageIdentityOk,versionCodeOk,arm64Ok,occtOk,goldenOk,reportEvidenceOk,productionBuild,summary);
    }
}
