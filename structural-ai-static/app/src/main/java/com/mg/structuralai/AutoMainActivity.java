...
public final class AutoMainActivity extends Activity {
    ...
    private void runAuto(){
        if(model==null){status.setText("Önce model seç");return;}
        if(assembly!=null&&assembly.isAssembly()){runAssemblyAuto();return;}
