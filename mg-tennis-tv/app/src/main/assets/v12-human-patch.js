...
function loadOpponent(){
  ...
  loader.load('opponent.glb',g=>{
    cleanOldOpponent();
    const model=g.scene;
    model.traverse(o=>{if(o.isMesh){o.castShadow=true;o.receiveShadow=true;if(o.material){o.material=o.material.clone();o.material.side=THREE.FrontSide;const r=o.material.roughness===undefined?.62:o.material.roughness;o.material.roughness=Math.min(.76,r);o.material.needsUpdate=true}}});
