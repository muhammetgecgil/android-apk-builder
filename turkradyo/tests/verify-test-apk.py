...
assert package and package[1] == "com.muhammetgecgil.turkradyo.test.v293", badging
assert "application-label:'MGtürk Radyo 2.8.7.4'" in badging, badging
assert "versionName='2.8.7.4-test'" in badging, badging
