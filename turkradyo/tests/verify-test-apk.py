...
assert package and package[1] == "com.muhammetgecgil.turkradyo.test.v303", badging
assert "application-label:'MGtürk Radyo 2.9.3'" in badging, badging
assert "versionName='2.9.3-test'" in badging, badging
