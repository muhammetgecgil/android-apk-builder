...
assert package and package[1] == "com.muhammetgecgil.turkradyo.test.v302", badging
assert "application-label:'MGtürk Radyo 2.9.2'" in badging, badging
assert "versionName='2.9.2-test'" in badging, badging
