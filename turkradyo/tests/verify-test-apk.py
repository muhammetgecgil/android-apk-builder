...
assert package and package[1] == "com.muhammetgecgil.turkradyo.test.v301", badging
assert "application-label:'MGtürk Radyo 2.9.1'" in badging, badging
assert "versionName='2.9.1-test'" in badging, badging
