...
function patch(){const b=target();if(!b)return;if(isP2()){delete b.dataset.p1Zap;b.dataset.p266Zap='1';b.innerHTML='<b>'+ICON+'</b>AKILLI ZAPPING';b.setAttribute('aria-label','Akıllı Zapping');b.title='Akıllı Zapping'}else if(b.dataset.p266Zap==='1'){delete b.dataset.p266Zap;if(!b.dataset.p1Zap){b.innerHTML='<b>♥</b>FAVORİLER';b.removeAttribute('aria-label');b.removeAttribute('title')}}}
