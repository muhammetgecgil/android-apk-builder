...
function fire(id,attempt=0){const direct=id==='trSlow273Card'?window.trOpenSlow279:id==='trTracks273Card'?window.trOpenTracks279:id==='trSmart273Card'?window.trOpenSmart279:id==='trGenre273Card'?(window.trOpenGenre280||window.trOpenGenre279):null;if(typeof direct==='function'){direct();queueReconcile(40);return}const p=$('#'+id);if(p&&typeof p.click==='function'){p.click();queueReconcile(40);return}if(attempt<18)setTimeout(()=>fire(id,attempt+1),110)}
