...
public class MainActivity extends Activity {
    ...
    private void buildWebView(){
        ...
        webView.loadUrl(A+"index.html?v=293");
    }
    ...
    public final class Bridge {
        ...
        @JavascriptInterface public String getSleepTimer(){return RadioSchedule.sleepJson(MainActivity.this);}
        @JavascriptInterface public String setSleepTimer(int minutes,boolean fade){return RadioSchedule.setSleep(MainActivity.this,System.currentTimeMillis()+minutes*60_000L,fade);}
        @JavascriptInterface public String clearSleepTimer(){return RadioSchedule.cancelSleep(MainActivity.this,true);}
        @JavascriptInterface public String getWakeAlarm(){return RadioSchedule.wakeJson(MainActivity.this);}
        @JavascriptInterface public String setWakeAlarm(int hour,int minute,String url,String name,boolean daily){return RadioSchedule.setWake(MainActivity.this,hour,minute,url,name,daily);}
        @JavascriptInterface public String clearWakeAlarm(){return RadioSchedule.cancelWake(MainActivity.this);}
    ...
    private void alarm(Uri u,boolean sleep){
        long when=l(u.getQueryParameter("when"),0);if(when<=System.currentTimeMillis())return;
        if(sleep)RadioSchedule.setSleep(this,when,"1".equals(u.getQueryParameter("fade")));
        else {java.util.Calendar date=java.util.Calendar.getInstance();date.setTimeInMillis(when);RadioSchedule.setWake(this,date.get(java.util.Calendar.HOUR_OF_DAY),date.get(java.util.Calendar.MINUTE),u.getQueryParameter("url"),u.getQueryParameter("name"),"1".equals(u.getQueryParameter("daily")));}
    }
    private void cancel(Uri u){if("sleepclear".equals(u.getHost()))RadioSchedule.cancelSleep(this,true);else RadioSchedule.cancelWake(this);}
    ...
    @Override protected void onResume(){super.onResume();RadioSchedule.restore(this,"resume");if(webView!=null){webView.onResume();webView.evaluateJavascript("window.dispatchEvent(new Event(\"turkradyo-schedules-changed\"))",null);}}
