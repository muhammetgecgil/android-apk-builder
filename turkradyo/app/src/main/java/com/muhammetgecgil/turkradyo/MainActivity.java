...
public class MainActivity extends Activity {
    ...
    private void buildWebView(){
        ...
        webView.loadUrl(A+"index.html?v=220");
    }
    ...
    public final class Bridge {
        ...
        @JavascriptInterface public void setQueue(String json,int idx){String q=json==null?"[]":json;getSharedPreferences("radio",MODE_PRIVATE).edit().putString("queue",q).putInt("queueIndex",Math.max(0,idx)).apply();CatalogHealthManager.scanAsync(MainActivity.this,q);}
    }
