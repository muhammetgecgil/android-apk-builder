...
public final class EngineeringReportEngine {
    ...
    public static String build(EngineeringProject p){
        ...
        b.append("Critical: ").append(r.criticalCount).append(" | Warning: ").append(r.warningCount).append(" | OK: ").append(r.okCount).append(" | Missing: ").append(r.missingCount).append("\n");
        ...
        else for(DesignReviewEngine.Finding f:r.findings)b.append(f.level).append(" | ").append(f.elementId).append(" | ").append(f.message).append("\n");
