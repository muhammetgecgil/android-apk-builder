...
public class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        TextView sub=text("Makine tasarım suite • proje, hesap, review, gearbox, assembly, optimizasyon, sistem seçimi ve Türkiye/Avrupa ürün eşleştirme",14,false,Color.rgb(71,85,105)); sub.setPadding(0,dp(4),0,dp(12)); root.addView(sub);
