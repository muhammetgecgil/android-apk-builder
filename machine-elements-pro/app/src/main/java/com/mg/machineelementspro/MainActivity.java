...
public class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        TextView sub=text("Makine tasarım suite • temel, ileri, drivetrain ve assembly çözümleri",14,false,Color.rgb(71,85,105)); sub.setPadding(0,dp(4),0,dp(12)); root.addView(sub);
        ...
        TextView footer=text("Temel hesaplar tek eleman ön kontrolleridir. Advanced Engineering gelişmiş failure-mode hesaplarını; Drivetrain System bağlı dişli-mil-rulman zincirini; Assembly Designer ise çoklu eleman seçimi ve kritik mod sıralamasını yürütür.",11,false,Color.rgb(100,116,139)); footer.setPadding(0,dp(18),0,0); root.addView(footer);
