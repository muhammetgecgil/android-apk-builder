...
public class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        TextView sub=text("Makine tasarım suite • temel, ileri, drivetrain, assembly, serbest geometri ve katalog seçimi",14,false,Color.rgb(71,85,105)); sub.setPadding(0,dp(4),0,dp(12)); root.addView(sub);
