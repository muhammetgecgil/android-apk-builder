...
public class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        TextView sub=text("Makine tasarım suite • temel, ileri, drivetrain, assembly, serbest geometri ve kütüphane",14,false,Color.rgb(71,85,105)); sub.setPadding(0,dp(4),0,dp(12)); root.addView(sub);
        ...
        TextView footer=text("Temel hesaplar tek eleman ön kontrolleridir. Advanced Engineering gelişmiş failure-mode hesaplarını; Drivetrain System bağlı dişli-mil-rulman zincirini; Assembly Designer çoklu eleman seçimini; Custom Geometry Lab kullanıcı tanımlı istasyonlar, civata koordinatları ve proje saklamayı; Engineering Library ise malzeme ve tercihli ölçü verilerini içerir.",11,false,Color.rgb(100,116,139)); footer.setPadding(0,dp(18),0,0); root.addView(footer);
