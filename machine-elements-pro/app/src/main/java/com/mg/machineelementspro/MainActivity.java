...
public class MainActivity extends Activity {
    ...
    private Button resultProductButton;
    ...
    private View buildUi() {
        ...
        TextView sub=text("Makine tasarım suite • proje, hesap, review, rapor, gearbox, assembly, optimizasyon ve Türkiye/Avrupa ürün eşleştirme",14,false,Color.rgb(71,85,105)); sub.setPadding(0,dp(4),0,dp(12)); root.addView(sub);
        ...
        Button review=navButton("DESIGN REVIEW →",Color.rgb(185,28,28));review.setOnClickListener(v->startActivity(new Intent(this,DesignReviewActivity.class)));root.addView(review,lp(-1,dp(58),dp(8)));
        Button report=navButton("ENGINEERING REPORT / PDF →",Color.rgb(75,85,99));report.setOnClickListener(v->startActivity(new Intent(this,EngineeringReportActivity.class)));root.addView(report,lp(-1,dp(58),dp(8)));
