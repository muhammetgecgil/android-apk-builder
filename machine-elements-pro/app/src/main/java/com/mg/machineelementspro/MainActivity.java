...
public class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        TextView sub=text("Mühendislik hesap motoru • 20 temel + ileri sistem modülleri",14,false,Color.rgb(71,85,105)); sub.setPadding(0,dp(4),0,dp(12)); root.addView(sub);

        Button advanced=new Button(this); advanced.setText("ADVANCED ENGINEERING →"); advanced.setAllCaps(false); advanced.setTypeface(Typeface.DEFAULT,Typeface.BOLD); advanced.setTextColor(Color.WHITE); advanced.setBackgroundColor(Color.rgb(30,64,175)); advanced.setOnClickListener(v->startActivity(new Intent(this,AdvancedActivity.class))); root.addView(advanced,lp(-1,dp(54),0));

        moduleSpinner=new Spinner(this); moduleSpinner.setAdapter(new ArrayAdapter<>(this,android.R.layout.simple_spinner_dropdown_item,CalculationEngine.MODULES)); root.addView(moduleSpinner,lp(-1,dp(54),dp(12)));
        ...
        TextView footer=text("Temel modüller ön boyutlandırma ve tek-eleman kontrolleridir. Advanced Engineering ekranı bağlantı rijitliği, iki düzlem yük aktarımı, rulman çifti, pres geçme ve gelişmiş yorulma gibi sistem hesaplarını içerir.",11,false,Color.rgb(100,116,139)); footer.setPadding(0,dp(18),0,0); root.addView(footer);
