...
public class AssemblyActivity extends Activity {
    ...
    private View build(){
        ...
        TextView sub=text("Bağlantılı eleman çözümü • otomatik seçim • kritik mod • ürün bağlantısı",14,false,Color.rgb(71,85,105));sub.setPadding(0,dp(4),0,dp(12));root.addView(sub);
