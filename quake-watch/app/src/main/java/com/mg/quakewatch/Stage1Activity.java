...
public class Stage1Activity extends Activity {
    ...
    private void build(){
        ...
        premium.setOnClickListener(v->startActivity(new Intent(this,ResearchConsoleActivity.class)));refresh.setOnClickListener(v->run());setContentView(root);
    }
    ...
    private GradientDrawable grad(int a,int b){GradientDrawable g=new GradientDrawable(GradientDrawable.Orientation.TL_BR,new int[]{a,b});return g;}
